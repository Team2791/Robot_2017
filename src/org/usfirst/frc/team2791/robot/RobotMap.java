...
public class RobotMap {
	...
	// DIO
	public static final int LEFT_DRIVE_ENCODER_PORT_A = (Robot.isCompBot? 3 : 9); 
	public static final int LEFT_DRIVE_ENCODER_PORT_B = (Robot.isCompBot? 2 : 8); 
	
	public static final int RIGHT_DRIVE_ENCODER_PORT_A = (Robot.isCompBot? 1 : 7); 
	public static final int RIGHT_DRIVE_ENCODER_PORT_B = (Robot.isCompBot? 0 : 6); 
	...
	public static final int GEAR_SPARK_PORT = 5; 
	
	// ANALOG
	public static final int IR_SENSOR_1 = (Robot.isCompBot? 2 : 0);
	public static final int IR_SENSOR_2 = (Robot.isCompBot? 3 : 1);
	...
	public static final int POWER_GEAR_INTAKE = 10;
}
