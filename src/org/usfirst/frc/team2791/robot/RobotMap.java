...
public class RobotMap {//to map ports; constants are in separate class
	...
	public static final int LEFT_SHOOTER_ENCODER_PORT_A = 0;
	public static final int LEFT_SHOOTER_ENCODER_PORT_B = 0;
	
	public static final int RIGHT_SHOOTER_ENCODER_PORT_A = 0;
	public static final int RIGHT_SHOOTER_ENCODER_PORT_B = 0;
