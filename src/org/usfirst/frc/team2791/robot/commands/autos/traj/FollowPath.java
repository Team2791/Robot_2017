...
public class FollowPath extends Command {
	...
	/**
	 * 
	 * @param path_ String name of path to follow, should match the file name
	 * @param mode the Automode that we want to have when following the path
	 */
