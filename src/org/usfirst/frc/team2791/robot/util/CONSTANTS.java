...
public class CONSTANTS { //for constants ONLY; ports are in RobotMap
	...
	public static double DRIVE_ENCODER_TICKS = 128;
	public static double SHOOTER_ENCODER_TICKS = 128*4;
	
	public static final double DRIVE_WHEEL_DIAMETER = 5.0;
	public static final double SHOOTER_WHEEL_DIAMETER = 5.0;
	...
	public static double SHOOTER_I_ZONE = 500;
	...
	public static double DRIVE_I_ZONE = 0;
