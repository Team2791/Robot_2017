...
public class ShakerDrivetrain extends Subsystem{
	...
	leftDriveEncoder.setDistancePerPulse(Util.tickToFeet(CONSTANTS.DRIVE_ENCODER_TICKS, CONSTANTS.DRIVE_WHEEL_DIAMETER)); 
	rightDriveEncoder.setDistancePerPulse(-Util.tickToFeet(CONSTANTS.DRIVE_ENCODER_TICKS, CONSTANTS.DRIVE_WHEEL_DIAMETER)); 
